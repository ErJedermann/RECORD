...
if __name__ == '__main__':
    fig_name = f"Areas (5th percentile, Q1, median, Q3, 95th percentile) of different rec-setups over different sniffing intervals"
    ...
    mapping = [
               ...
               (7, 0, "100kmFibo_cont_28800sec_3eves_weakEvents_noisyPrediction.csv"),
               (8, 0, "100kmFibo_cont_57600sec_3eves_weakEvents_noisyPrediction.csv"),
    ]
